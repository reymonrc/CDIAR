var List = {
    view: function() {
      ...
      m('thead',
        m('tr',m('th','BD'),m('tr',{colspan: 16},'ALUMNO'),m('tr',{colspan: 6},'TUTOR'))
        m('tr',
          m('th','Objeto'),
          m('th','CURP'),m('th','NOMBRE'),m('th','P APELLIDO'),m('th','S APELLIDO'),
          m('th','NIVEL'),m('th','GRADO'),m('th','GRUPO'),m('th','GENERO'),
          m('th','CALLE'),m('th','NUMERO'),m('th','ENTIDAD'),m('th','MUNICIPO'),m('th','COLONIA'),m('th','CP'),m('th','TEL'),m('th','TEL 2),m('th','CORREO-E'),m('th','CORREO-E 2'),
                                                                                                                               
        )
      ),
      m('tbody', 
            m('tr', m('td', 'PREINSCRIPCIONES_DATOS'), m('td', {Title:'VARCHAR2(18 BYTE)'}, 'CURP'), m('td', {Title:'VARCHAR2(64 BYTE)'}, 'NOMBRES'),
             m('td', {Title:'VARCHAR2(64 BYTE)'},'PRIMERAPELLIDO'), m('td', {Title:'VARCHAR2(64 BYTE)'}, 'SEGUNDOAPELLIDO'), m('td', {Title:'VARCHAR2(32 BYTE)'}, 'NIVEL_EDUCATIVO'),
             m('td', {Title:'NUMBER(1,0)'},'GRADO'), m('td'), m('td'),
