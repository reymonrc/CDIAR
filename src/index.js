var List = {
    view: function() {
      ...
      m('thead',
        m('tr',m('th',{colspan: 2},'BD'),m('th',{colspan: 21},'ALUMNO'),m('th',{colspan: 6},'TUTOR'),m('th',{colspan: 2},'ESCUELA')),
        m('tr',
          m('th','Servidor'),m('th','Objeto'),m('th','CICLO'),
      ...
      m('tbody',
            m('tr',m('th',{rowspan: 3},'IP: 2.2'), m('td.list-item', 'PREINSCRIPCIONES_DATOS'),m('td'), m('td', {Title:'VARCHAR2(18 BYTE)'}, 'CURP'), m('td', {Title:'VARCHAR2(64 BYTE)'}, 'NOMBRES'),
